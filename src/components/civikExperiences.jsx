...
import heroBg from "../assets/images/civik-experiences-hero-bg.png";
import rightImage from "../assets/images/civik-experiences-right-img.png";
                ...
                <div className="project-hero-container">
                    ...
                    <div className="project-hero-left">
                        ...
                        <h1 className="project-hero-title">
                            CIVIK
                            <br />
                            <span className="highlight-electric">EXPERIENCES</span>
                        </h1>
                        ...
                        <p className="project-hero-desc">
                            A purpose-driven experiential platform focused on culture, citizenship, and the Constitution, creating meaningful experiences that encourage awareness, participation, dialogue, and a deeper connection with society.
                        </p>

                        <div className="project-meta-row">
                            <div className="project-meta-item">
                                <span className="meta-label">Industry</span>
                                <span className="meta-value">Culture, Events & Civic Engagement</span>
                            </div>
                            <div className="project-meta-divider"></div>
                            <div className="project-meta-item">
                                <span className="meta-label">Project Type</span>
                                <span className="meta-value">Experiential Website</span>
                            </div>
                            
                            <div className="project-meta-item project-meta-action">
                                <a
                                    href="https://civikexperiences.com"
                                    target="_blank"
                    ...
                    <div className="project-hero-right">
                        <div className="project-visual-wrapper">
                            <img src={rightImage} alt="Civik Experiences Visualization" />
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="project-tech-container">
                    ...
                    <div className="project-tech-left">
                        ...
                        <p className="project-tech-desc">
                            A modern technology stack used to create an immersive, responsive, and engaging digital experience.
                        </p>
                    </div>
                ...
                <div className="project-cta-container">
                    ...
                    <div className="project-cta-left">
                        ...
                        <p className="project-cta-desc">
                            Discover meaningful experiences, ideas, and initiatives designed to connect people, culture, and communities.
                        </p>
                    </div>
...
export default CivikExperiences;