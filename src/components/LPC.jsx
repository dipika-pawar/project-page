...
import heroBg from "../assets/images/lpc-facility-bg-hero section.png";
import rightImage from "../assets/images/lpc-right-side-img.png";
        ...
        <div className="project-hero-container">
          ...
          <div className="project-hero-left">
            ...
            <h1 className="project-hero-title">
              LPC FACILITY
              <br />
              <span className="highlight-electric">SERVICES</span>
            </h1>
            ...
            <p className="project-hero-desc">
              A modern facility management platform delivering safe, effective, and reliable solutions for pest control, cleaning, flooring, and specialized maintenance needs.
            </p>

            <div className="project-meta-row">
              <div className="project-meta-item">
                <span className="meta-label">Industry</span>
                <span className="meta-value">Facility Management & Services</span>
              </div>
          ...
          <div className="project-hero-right">
            <div className="project-visual-wrapper">
              <img src={rightImage} alt="LPC Logistics Visualization" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="project-tech-container">
          ...
          <div className="project-tech-left">
            ...
            <p className="project-tech-desc">
              A modern technology stack used to create a responsive, professional, and easy-to-navigate facility management website.
            </p>
          </div>
        ...
        <div className="project-cta-container">
          ...
          <div className="project-cta-left">
            ...
            <p className="project-cta-desc">
              Discover reliable facility management and maintenance solutions designed to keep spaces cleaner, safer, and better maintained.
            </p>
          </div>
