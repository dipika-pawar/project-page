...
import heroBg from "../assets/images/cajnk-hero-bg.png";
import rightImage from "../assets/images/cajnk-right-side-img.png";
        ...
        <div className="project-hero-container">
          ...
          <div className="project-hero-left">
            ...
            <h1 className="project-hero-title">
              CAJNK &
              <br />
              <span className="highlight-electric">CO</span>
            </h1>
            ...
            <p className="project-hero-desc">
              A trusted financial advisory platform delivering expert solutions in taxation, audit, compliance, GST, FEMA, and NRI advisory, helping businesses and individuals make informed financial decisions.
            </p>

            <div className="project-meta-row">
              <div className="project-meta-item">
                <span className="meta-label">Industry</span>
                <span className="meta-value">Financial Services & Advisory</span>
              </div>
        ...
        <div className="project-tech-container">
          ...
          <div className="project-tech-left">
            ...
            <p className="project-tech-desc">
              A modern technology stack used to build a professional, responsive, secure, and user-friendly financial advisory platform.
            </p>
          </div>
        ...
        <div className="project-cta-container">
          ...
          <div className="project-cta-left">
            ...
            <p className="project-cta-desc">
              Explore CA JNK & Co and discover professional financial, taxation, compliance, audit, and advisory solutions.
            </p>
          </div>
