...
import heroBg from "../assets/images/section1-bg-beyond-six-senses.png";
import rightImage from "../assets/images/right-img-section1-beyond-six-senses.png";
        ...
        <div className="project-hero-container">
          ...
          <div className="project-hero-left">
            ...
            <h1 className="project-hero-title">
              BEYOND
              <br />
              <span className="highlight-electric">SIX SENSES</span>
            </h1>

            <div className="project-category-pill">
              counselling and consulting platform
            </div>

            <p className="project-hero-desc">
              A professional counselling and consulting platform designed to
              provide personalized guidance, expert support, and practical
              solutions to help individuals and organizations achieve clarity,
              growth, and meaningful outcomes.
            </p>

            <div className="project-meta-row">
              <div className="project-meta-item">
                <span className="meta-label">Industry</span>
                <span className="meta-value">counselling and consulting</span>
              </div>
              ...
              <div className="project-meta-item project-meta-action">
                <a
                  href="https://beyondsixsenses.com"
                  target="_blank"
        ...
        <div className="project-cta-container">
          ...
          <div className="project-cta-left">
            ...
            <p className="project-cta-desc">
              Explore the live platform and discover a digital experience
              inspired by extraordinary hospitality, wellness, and meaningful
              journeys.
            </p>
          </div>
